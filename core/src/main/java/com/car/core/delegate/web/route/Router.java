package com.car.core.delegate.web.route;
...
public class Router {
    ...
    public final void loadData(WebDelegate delegate, String data) {
        delegate.getWebView().loadDataWithBaseURL(null,data,"text/html","utf-8",null);
    }
